          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center p-6 md:p-8 lg:p-10">
            <div className="stagger-fade-in">
              ...
              <p className="text-sm md:text-base text-gray-600 mb-6">
                Our exclusive NFT collection offers unique benefits and utility within the GachaPeng ecosystem.
              </p>
              ...
              <div className="space-y-5">
                ...
                <div className="card-hover p-4 md:p-5 rounded-xl border-l-4 border-l-primary bg-gray-50">
                  ...
                  <p className="text-sm md:text-base text-gray-600">
                    Have your say in the future development of GachaPeng through exclusive voting rights.
                  </p>
                </div>
              </div>
